  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          className="w-14 h-14 whatsapp-btn hover:whatsapp-btn text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
          onClick={() => window.open("https://wa.me/233249302083", "_blank")}
